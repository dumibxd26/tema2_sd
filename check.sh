...
0.01 0.01 0.012 0.02 0.03 0.03 0.5 0.1 0.2 1.2)
...
function printReadme {
    ...
    if test -f "README"; then
        echo -ne  "\n\tREADME detected. You get 10p <3 :(\n\n"
        REAMDE_BONUS=$README_POINTS
    else
        echo -ne "\n\tNO README detected. You get 0p :(\n\n"
    fi
    # echo -ne "\n\t\tYou got a bonus of $CODING_STYLE_BONUS/$MAX_BONUS.\n\n"
...
function printTotalPoints {
    ...
    sum=$(expr $TOTAL + $CODING_STYLE_BONUS + $REAMDE_BONUS)
    echo -ne "\n\t Your final score is: $sum / 100. \n"
